...
\NormalTok{foto2<-}\StringTok{ }\NormalTok{foto }\OperatorTok{%>%}\StringTok{  }\KeywordTok{resize}\NormalTok{(}\DataTypeTok{size_x =} \DecValTok{80}\NormalTok{, }\DataTypeTok{size_y =} \DecValTok{80}\NormalTok{, }\DataTypeTok{interpolation_type =}\NormalTok{ 1L)}
